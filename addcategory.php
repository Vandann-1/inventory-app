                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="category_desc" placeholder="Enter category description name"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <a class="btn btn-submit me-2" onclick="document.getElementById('create_category').submit();">Create </a>
