...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $parent_category = validate_input($_POST['parent_category']); // Pass category_code
    $category_name = validate_input($_POST['category_name']);
    $description = validate_input($_POST['category_desc']);

    if (empty($parent_category) || empty($category_name) || empty($description)) {
        ...
        if (isset($response['subcategory'])) {
            ...
            $msg = "<div class='alert alert-danger'>". htmlspecialchars($response['message']) ."</div>";
        }
    }
}
...
<head>
    ...
    <title>Create Sub Category | TS</title>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="parent_category">
                                            ...
                                            <?php foreach ($categories as $category) { 
                                                ...
                                                ?>
                                                <option value="<?= htmlspecialchars($category['category_code']); ?>"><?= htmlspecialchars($category['name']); ?></option>
                                            <?php }} ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="category_desc" placeholder="Enter sub category description name"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
